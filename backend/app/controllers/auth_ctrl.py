...
def register() -> dict[str, Any]:
    ...
    # Informational only: flag weak passwords for security monitoring without
    # blocking registration (the enforced minimum lives in the schema).
    strength = check_password_strength(data.password)
    if strength["strength"] == "weak":
        logger.warning(
            "weak_password_registered",
